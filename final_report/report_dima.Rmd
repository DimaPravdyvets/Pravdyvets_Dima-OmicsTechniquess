...
We already have the matrices, model and data, so we can get the toptables for each comparison, join the into 1 and do a volcano plot of this abomination
```{r}
...
merge(topTab_itvscp[1:1,],topTab_itvsct[1:1,])
